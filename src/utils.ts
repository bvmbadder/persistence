import k from "./assets/wallets/k.png";
import cos from "./assets/wallets/cos.png";
import leap from "./assets/wallets/leap.svg";

import atom from "./assets/tokens/atom.svg";
import dydx from "./assets/tokens/dydx.svg";
import pstake from "./assets/tokens/pstake.svg";
import shd from "./assets/tokens/shd.svg";
import stkatom from "./assets/tokens/stkatom.svg";
import stkdydx from "./assets/tokens/stkdydx.svg";
import stkstars from "./assets/tokens/stkstars.svg";
import stkxprt from "./assets/tokens/stkxprt.svg";
import usdc from "./assets/tokens/usdc.svg";
import usdt from "./assets/tokens/usdt.svg";
import wbtc from "./assets/tokens/wbtc.svg";
import xprt from "./assets/tokens/xprt.svg";
...
export interface TokenssDataType {
  id: number;
  name: string;
  icon: string;
  value: number;
}
export const wallets: WalletsDataType[] = [
  {
    id: 1,
    name: "Keplr",
    icon: k,
...
export const tokens: TokenssDataType[] = [
  {
    id: 1,
    name: "ATOM",
    icon: atom,
